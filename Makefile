#############################################################################
# Makefile for building: DevasCoin-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: ter ago 5 21:36:46 2014
# Project:  DevasCoin-qt.pro
# Template: app
# Command: /usr/bin/qmake-qt4 USE_UPNP=- -o Makefile DevasCoin-qt.pro
#############################################################################
...
LIBS          = $(SUBLIBS)  -L/usr/lib/i386-linux-gnu /home/marciano/devascoin/src/leveldb/libleveldb.a /home/marciano/devascoin/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtCore 
AR            = ar cqs
RANLIB        = 
...
$(TARGET): /home/marciano/devascoin/src/leveldb/libleveldb.a /home/marciano/devascoin/build/build.h build/ui_coincontroldialog.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: DevasCoin-qt.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) USE_UPNP=- -o Makefile DevasCoin-qt.pro
...
/home/marciano/devascoin/src/leveldb/libleveldb.a: FORCE
	cd /home/marciano/devascoin/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-fpermissive -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/home/marciano/devascoin/build/build.h: FORCE
	cd /home/marciano/devascoin; /bin/sh share/genbuild.sh /home/marciano/devascoin/build/build.h
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/icons/devascoin-16.png \

...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "DevasCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"seed.devascoin.org", "seed.devascoin.org"},
    {"seed1.devascoin.org", "seed1.devascoin.org"},
    {"seed2.devascoin.org", "seed2.devascoin.org"},
    {"seed3.devascoin.org", "seed3.devascoin.org"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("DevasCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("DevasCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("DevasCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("DevasCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. DevasCoin is probably already running."), addrBind.ToString().c_str());
        else

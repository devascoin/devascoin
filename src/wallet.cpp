...
// DevasCoin: total coins staked (non-spendable until maturity)
...
// DevasCoin: check 'spent' consistency between wallet and txindex
// DevasCoin: fix wallet spent state according to txindex
...
// DevasCoin: disable transaction (only for coinstake)
